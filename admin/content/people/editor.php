                ...
                if ( !empty($_GET['edid']) ) {
                    ...
                    <form action="./editor_ok.php" method="post" name="myform" enctype="multipart/form-data">
                        <table>
                            ...
                            <tr>
                                <td class="tdr">政治面貌：</td><td class="tdl"><input type="text" name="face"  class="pt" value="<?= $row['face'] ?>"></td>
                            </tr>
                            <tr>
                                <td class="tdr">系(院)：</td><td class="tdl"><input type="text" name="xibie"  class="pt" value="<?= $row['xibie'] ?>"></td>
                            </tr>
                            <tr>
                                <td class="tdr">班 别：</td><td class="tdl"><input type="text" name="class"  class="pt" value="<?= $row['class'] ?>"></td>
                            </tr>
                            <tr>
