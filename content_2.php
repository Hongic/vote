...
<div id="main">
    <div id="content">
        ...
        <div class="xw">
            ...
            var heights=258;              
            var counts=4;   
            img1=new Image ();img1.src='admin/content/uploads/2013032204.jpg'; 
            img2=new Image ();img2.src='admin/content/uploads/2013032206.jpg'; 
            img3=new Image ();img3.src='admin/content/uploads/2013032207.jpg'; 
            img4=new Image ();img4.src='admin/content/uploads/201303241.jpg';  
            ...
            <div class="xw_middle">
                <div class="dbt"><h5><!--begin--><a href="introduce.php" target="_blank">2012年度河池学院大学生年度人物动态</a><!--end--></h5>
            ...
            <div class="xw_right" style="line-height:20px; font-size:12px">
                ...
                网络投票,应以“公平、公正、公开”为原则，利用本次活动为契机，充分挖掘典型，树立榜样，广泛宣传，进一步加强学风、校风建设。<br />
                <strong>二、投票细则</strong><br>
                1、投票对象：全院师生</br>
                2、投票要求：每天一个IP只能投一名参赛人员</br>
                3、投票截止时间：即日起至2013年**月**日……
                    <pre>                                          <a href="notice.php" target="_blank">[详细]</a></pre>
            </div> 
        </div>
        ...
        ?>  
            ...
            while ($row = $result->fetch_assoc()) {             //循环输出投票人信息
            	...
            	<center>
                <div id="tpbt">
              <input name="tpsubmit" id="tpsubmit" type="submit" value="投 票" style="font-size:16px; width:80px; height:30px;">&nbsp;&nbsp;&nbsp;<input name="resetbont" id="resetbont" type="reset" value="重 选" style="font-size:16px; width:80px; height:30px;">
              <!--<a id="a1" class="thickbox"><img style="float:left; cursor:pointer;" src="http://i4.cqnews.net/gdcq2012/69168.files/images/tpbt.gif" /></a>
