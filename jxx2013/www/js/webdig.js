var ROOTDM = [".tianshannet.com", ".tianshannet.com.cn", ".sznews.com", ".sznews.cn", ".baoannet.com", ".sznsnews.com", ".szps2009.com", ".psxq.gov.cn", ".szlgnews.com", ".yantian.com.cn", ".szmil.com", ".futianhs.com", ".lsgmw.com", ".szgm.gov.cn", ".stcn.com", ".bjreview.com", ".bjreview.com.cn", ".hbtv.com.cn", ".cqnews.net", ".86angel.com", ".cbg.cn", ".chinadaily.com.cn", ".chinadaily.cn", ".jznews.com.cn", ".8234567.com"];
...
_webdigObj.pro = function() {
   ...
   // alert(_webdigObj.pagetype);alert(_webdigObj.catalogs);alert(_webdigObj.contentid);
};
...
_webdigObj.discuz = function() {
    var author = _webdigObj.getMeta('author');
    if(document.domain.indexOf('chinadaily') != -1) author="Discuz";

    if(author.indexOf('Discuz') != -1) {
        var o = new Object();
        o.version  = _webdigObj.getMeta('generator');
        var href = document.location.href;

        if(href.indexOf('submit=yes') !=-1 && href.indexOf('&tid=') == -1 ) {
            o.submit=true;
            var s = document.getElementById('messagetext');
            if(s) {
                var message = s.innerHTML;
                var regexs = ['tid=([0-9]+)', '([0-9]+)-[0-9]+-[0-9]+'];
...
if((_webdigObj.contentid).match(/\D/)){
	    		    var s="http://[^\_]*\_(\\d+)(|\_\\d*)\.htm.?$";  	
	   				var str = "";
	   				
	   			    str = location.href.replace("index.htm", "").replace("index.html", "").replace("index.jsp", "");
     				//str = "http://www.btv.com.cn/btvindex/2010zt/2010hqcw/content/2010-11/19/content_1603244_2.htm";
